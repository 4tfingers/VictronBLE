/**
 * victronble â€” pure C99 decoder for Victron Energy "Instant Readout" BLE
 ...
 * tracking) is the caller's job â€” the nonce is returned in @p out.
 */
...
/** Key check byte test â€” pick the right key from several without decrypting. */
